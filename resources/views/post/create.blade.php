...
@endif
    ...
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Konten</label>
        <textarea name="post_content" type="text" class="form-control" id="formGroupExampleInput2" placeholder="Masukkan Konten" style="width: 163%; margin-left: 20px; background-color: #FCF6E3; border: 2px solid #03485D;""></textarea>
    </div>
    <div class="mb-3">
        <label for="formGroupExampleInput2" class="form-label">Foto</label>
        <input name="post_image" type="file" class="form-control">
