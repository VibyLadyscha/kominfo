...
@endif
    ...
    <div class="bungkus-profile">    
        <div class="profile">
            ...
            @csrf
            <div class="mb-3">
                <label for="formGroupExampleInput" class="form-label mt-2">Komentar</label>
                <input type="hidden" name="post_id" value="{{ $post->id }}">
                <textarea name="comment_content" class="form-control" id="formGroupExampleInput" placeholder="Masukkan Komentar" style="width: 411%; margin-left: 20px; background-color: #FCF6E3; border: 2px solid #03485D;"></textarea>
            </div>
        </div>
    </div>
    <div class="bungkus-b">
